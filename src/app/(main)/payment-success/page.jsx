...
export default async function PaymentSuccess({ searchParams }) {
  ...
  // ADDED: don't record a purchase for an unpaid/abandoned session
  if (payment_status !== 'paid') {
    throw new Error('Payment has not been completed.');
    // Optional improvement later: redirect to the book page or a friendlier
    // "payment not completed" screen instead of throwing — up to you.
  }
