...
import { adminDeleteMutation } from "@/lib/api/admin/action";
import toast from "react-hot-toast";

export default function AdminBookDeleteModal({ isOpen, onClose, book, onDeleted }) {
  ...
  const handleDelete = async () => {
    ...
    const res = await adminDeleteMutation(book._id);
        ...
        <Modal.Container className="">
          <Modal.Dialog className="bg-[#0f0f0f] border border-zinc-800 max-w-sm w-full rounded-2xl overflow-hidden">
            ...
            <div className="flex justify-end gap-3 px-6 py-4 pt-4 border-t border-zinc-800">
              ...
              >
                {isDeleting ? <Spinner size="sm" /> : <FiTrash2 size={14} />}
